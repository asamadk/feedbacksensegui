                        ...
                        logicList?.map(logic => {
                            return (
                                <Box key={logic.id} >
                                    <Box sx={logicListContainer} >
                                        <Box marginBottom={'20px'} justifyContent={'space-between'} display={'flex'} >
                                            ...
                                            <Select
                                                ...
                                                onChange={(e) => handleOperatorChange(e, logic.id)}
                                            >
                                                {
                                        ...
                                        {
                                            showAnswerList && logic.showValue &&
                                            <Box marginBottom={'20px'} textAlign={'end'} >
                                                <Select
                                                    ...
                                                    size='small'
                                                    value={logic.value}
                                                    onChange={(e) => handleValueChange(e, logic.id)}
                                                >
                                                    {
                                        ...
                                        {
                                            showAutoComplete && logic.showValue &&
                                            <Box marginBottom={'20px'} sx={{ textAlign: '-webkit-right' }}>
                                                <Autocomplete
                                                    ...
                                                    freeSolo
                                                    onChange={(e) => handleAutoCompleteSave(e, logic.id)}
                                                    renderTags={(value, getTagProps) =>
                                                        value.map((option, index) => (
                                                            <Chip
                                                                ...
                                                                label={option}
                                                                {...getTagProps({ index })}
                                                                onDelete={(e) => handleChipDelete(option, logic.id)}
                                                            />
                                                        ))
                                                    }
                                                    renderInput={(params) => (
                                        ...
                                        <Box justifyContent={'space-between'} display={'flex'} >
                                            ...
                                            <CssTextField
                                                ...
                                                variant="outlined"
                                                value={logic.path}
                                                onChange={(e) => handlePathNameChange(e, logic.id)}
                                                size={'small'}
                                                style={{ width: '70%' }}
                                            />
                                        </Box>
                                    ...
                                    <Box textAlign={'end'} >
                                        <IconButton
                                            onClick={() => handleRemoveLogic(logic.id)}
